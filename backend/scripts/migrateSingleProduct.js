...
const MIGRATION_CONFIG = {
    ...
    FIREBASE_CONFIG: {
        ...
        storageBucket: "eccomerce-bluetec-saopaulo", // ⚠️ NUEVO BUCKET
...
try {
    ...
    console.log(`📋 Bucket objetivo: eccomerce-bluetec-saopaulo`);
} catch (error) {
...
async function migrateSingleProduct() {
    try {
        ...
        log(`Bucket destino: eccomerce-bluetec-saopaulo`, 'INFO');
...
async function testConnection() {
    try {
        ...
        log('Debug info:', 'INFO');
        log(`Bucket configurado: eccomerce-bluetec-saopaulo`, 'INFO');
