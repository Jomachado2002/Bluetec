// frontend/src/common/index.js - ENDPOINTS COMPLETOS PARA EL SISTEMA
...
const SummaryApi = {
    ...
    bancardCards: {
        ...
        testList: {
            url: `${backendDomain}/api/bancard/test-listar`,
            method: 'get'
        },
        testPayment: {
    ...
    bankTransfers: {
        ...
        uploadProof: {
            url: `${backendDomain}/api/bank-transfers`,
            method: 'post'
        },
        ...
        // Admin: Obtener todas las transferencias
        getAll: {
            url: `${backendDomain}/api/admin/bank-transfers`,
            method: 'get'
        },
    ...
    // ===========================================
    // ✅ GESTIÓN DE COMPRAS DE USUARIOS (ACTUALIZADO)
    // ===========================================
    userPurchases: {
        // Obtener compras del usuario actual
        getUserPurchases: {
            url: `${backendDomain}/api/usuario/compras`,
            method: 'get'
        },
        ...
        getUserStats: {
            url: `${backendDomain}/api/usuario/estadisticas-compras`,
            method: 'get'
        },
        // Admin: Obtener todas las compras
        getAllPurchases: {
            url: `${backendDomain}/api/admin/compras`,
            method: 'get'
        }
    }
};
