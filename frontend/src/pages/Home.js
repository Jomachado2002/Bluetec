...
useEffect(() => {
  ...
  return (
    <>
      <Helmet>
        <title>BlueTec | Lo Mejor en Tecnología en Paraguay</title>
        <meta
          name="description"
          content="Descubre los mejores productos de informática, notebooks, placas madre, computadoras ensambladas, monitores y más en BlueTec. ¡Ofertas exclusivas en Paraguay!"
        />
        <meta
          name="keywords"
