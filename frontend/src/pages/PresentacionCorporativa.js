...
const PresentacionCorporativa = () => {
  ...
  // Logo SVG Component
  const BlueTecLogo = ({ className = "w-20 h-8" }) => (
    <div className={`${className} flex items-center space-x-2`}>
      ...
      <div className="text-white">
        <div className="text-sm font-bold leading-tight">BlueTec Alliance</div>
        <div className="text-xs opacity-80 leading-tight">Tu Socio Estratégico</div>
      </div>
    </div>
  );
      ...
      content: (
        <div className="h-full flex flex-col justify-center items-center bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 text-white relative overflow-hidden">
          ...
          <div className="absolute bottom-6 right-6 z-20">
            <BlueTecLogo className="w-32 h-10" />
          </div>
        </div>
      )
    },
      ...
      content: (
        <div className="h-full bg-gradient-to-br from-slate-50 via-blue-50 to-cyan-50 p-4 md:p-8 lg:p-12 overflow-auto relative">
          ...
          <div className="absolute bottom-4 md:bottom-6 right-4 md:right-6 z-20">
            <BlueTecLogo className="w-24 md:w-32 h-8 md:h-10" />
          </div>
        </div>
      )
    },
                  ...
                  <div className="space-y-4 md:space-y-6">
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <p className="opacity-90 text-purple-300 text-sm md:text-base">ventas@bluetec.com.py</p>
                      </div>
                    </div>
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <p className="opacity-90 text-blue-300 text-sm md:text-base">www.bluetec.com.py</p>
                      </div>
                    </div>
                    <div className="flex items-center space-x-4">
  ...
  const downloadPDF = async () => {
    ...
    try {
      ...
      pdf.save('BlueTec-Presentacion-Corporativa.pdf');
          ...
          <div className="flex justify-center items-center space-x-4 mb-6">
            ...
            <div>
              <h1 className="text-3xl lg:text-4xl font-black text-gray-800 bg-gradient-to-r from-blue-800 to-cyan-700 bg-clip-text text-transparent">
                BlueTec - Presentación Corporativa
              </h1>
        ...
        {!isFullscreen && (
          <div className="mt-8 bg-gradient-to-r from-blue-900 via-purple-900 to-cyan-900 text-white p-6 rounded-2xl text-center shadow-2xl">
            <div className="flex justify-center items-center space-x-4 mb-4">
              ...
              <div>
                <h3 className="text-2xl font-bold bg-gradient-to-r from-cyan-400 to-white bg-clip-text text-transparent">BlueTec</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center text-sm mb-4">
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-3">
                <div className="flex items-center justify-center space-x-2 mb-1">
                  ...
                  <span className="font-semibold">www.bluetec.com.py</span>
                </div>
            ...
            <div className="border-t border-white/20 pt-4">
              <div className="flex flex-col md:flex-row justify-between items-center space-y-2 md:space-y-0">
                <div className="text-xs opacity-80">
                  © 2023-2025 BlueTec Alliance. Tu Socio Estratégico en Tecnología
                </div>
